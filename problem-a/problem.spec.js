...
describe('Has appropriate headings', () => {
  ...
  test("Headings are meaningful (don't use use h6 for styling)", () => {
...
describe('Content is annotated for machines/screen-readers', () => {
  ...
  test('Image has alternative test', () => {
    ...
    expect(alt.toLowerCase()).not.toMatch(/(image|picture) of/i); //alt attribute doesn't mention image
  })
})
